...
read them in dotted-decimal notation, which is basically the number split 
into 4 chunks of 8 bits, converted to decimal, and delmited by a dot.
...
def ip_to_num(ip):
    return ''.join([oct(i) for i in (ip.split('.'))])
